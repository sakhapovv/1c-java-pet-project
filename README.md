...
<p>
  <a href="#запуск-java-приложения-через-docker">
    <img src="https://img.shields.io/badge/Запуск-Java%20Docker-blue" alt="Запуск Java через Docker">
  </a>
  <a href="#1с-http-api">
...
[Запуск Java через Docker](#запуск-java-приложения-через-docker) |
...
## Запуск Java-приложения через Docker
